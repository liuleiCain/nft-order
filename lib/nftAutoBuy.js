    ...
    class NftAutoBuy {
        ...
        async addTask(task) {
            try {
                ...
                this.taskList[taskName].web3Provider = task.web3Provider
                this.taskList[taskName]._opensea = new openSea(this._networkName, this.taskList[taskName].web3Provider)
        ...
        async _getGemOrdersList(taskName) {
            ...
            try {
                ...
                let {data} = await axios({
                    method: "POST", url: "https://nft-aggregator-api.herokuapp.com/assets",
                    headers: {
                        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36",
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        "Host": "nft-aggregator-api.herokuapp.com",
                ...
                let account = task.web3Provider.getAddress(0)
        ...
        */
        ...
        _checkTaskError(task) {
            try {
                ...
                if ((!task.hasOwnProperty("web3Provider") || typeof task.web3Provider !== "object")) {
